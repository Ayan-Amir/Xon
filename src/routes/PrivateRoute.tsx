...
export const PrivateRoute: React.FC<PrivateRouteProps> = ({ children }) => {
  ...
  return accessToken ? (
    <div className='flex gap-[1.875rem] xxl:gap-10 lg:h-screen lg:overflow-hidden'>
      <div className='hidden lg:block !w-[20.5rem]'>
        <Sidebar />
      </div>
      {children}
    </div>
    ...
    <div className='w-full min-h-screen flex justify-center md:justify-normal'>
      ...
      <div className='bg-authBg xl:w-[calc(100%-38.75rem)] lg:w-[calc(100%-27.75rem)] min-h-screen fixed right-0 overflow-hidden hidden lg:block'>
        ...
        <div className='pl-[5rem] w-full h-full overflow-hidden'>
          <img
