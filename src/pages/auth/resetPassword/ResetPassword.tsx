...
export function ResetPassword() {
  ...
  const { mutate: handleResetPassword, isLoading: resetPasswordLoading } = usePostMutation(
    'reset-password',
  ...
  return (
    <div className='w-full lg:max-w-[27.5625rem] xl:max-w-[38.75rem] h-full flex justify-center'>
      <div className='w-full max-w-[21.875rem] xl:max-w-[26.5rem] lg:max-w-[18.875rem] md:max-w-[26.5rem] flex flex-1 flex-col items-center justify-center py-[1.875rem] xl:py-[3.375rem] lg:py-9 md:py-[3.25rem]'>
        ...
        >
          <div className='flex flex-col gap-6 md:gap-[1.875rem] lg:gap-5 xl:gap-3 mt-[1.875rem] xl:mt-[1.875rem] lg:mt-6'>
            <Input
            ...
            <Input
              ...
              togglePasswordVisibility={() => setConfirmPassword(!confirmPassword)}
            />
          </div>
