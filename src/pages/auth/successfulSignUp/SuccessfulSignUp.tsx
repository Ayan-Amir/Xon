    ...
    <div className='h-screen flex justify-center items-center'>
      <div className='w-[21.875rem] md:w-[29.125rem] flex flex-col items-center gap-y-3 md:gap-y-10'>
        ...
        <div className='flex flex-col gap-4 md:gap-y-2 text-center'>
          <h1 className='text-3xl font-bold leading-[2.625rem] md:leading-[3.625rem] md:text-[2.625rem] text-darkPrimary'>
            Congratulations
          </h1>
          <p className='text-base font-normal leading-[1.375rem] md:leading-[2.125rem] md:text-2xl text-darkPrimary'>
