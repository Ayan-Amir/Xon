...
var compare_versions_exports = {};
__export(compare_versions_exports, {
  compare: () => compare,
...
var validate, compare, satisfies, semver, validateAndParse, isWildcard, tryParse, forceType, compareStrings, compareSegments, operatorResMap, allowedOperators, assertValidOperator;
var init_compare_versions = __esm({
  "node_modules/compare-versions/index.mjs"() {
    validate = (v) => typeof v === "string" && /^[v\d]/.test(v) && semver.test(v);
...
// node_modules/react-cache-buster/dist/CacheBuster.js
var require_CacheBuster = __commonJS({
  "node_modules/react-cache-buster/dist/CacheBuster.js"(exports) {
    ...
    var compareVersions2 = (init_compare_versions(), __toCommonJS(compare_versions_exports));
    ...
    function CacheBuster(_ref) {
      ...
      var isThereNewVersion = function isThereNewVersion2(metaVersion, currentVersion2) {
        if (reloadOnDowngrade) {
          return !compareVersions2.compare(metaVersion, currentVersion2, "=");
        }
        return compareVersions2.compare(metaVersion, currentVersion2, ">");
      };
...
export default require_CacheBuster();
//# sourceMappingURL=react-cache-buster_dist_CacheBuster.js.map
