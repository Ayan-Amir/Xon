...
export declare const FormattingToolbarPositioner: <BSchema extends Record<string, import("@blocknote/core").BlockSpec<string, import("@blocknote/core").PropSchema, boolean>> = {
    readonly paragraph: {
    ...
    editor: BlockNoteEditor<BSchema>;
    formattingToolbar?: FC<FormattingToolbarProps<BSchema>> | undefined;
